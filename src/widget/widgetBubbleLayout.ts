...
export const WIDGET_QUEUE_ROW_HEIGHT = 64;

const WIDGET_COMPACT_SURFACE_PADDING = 8;
const WIDGET_HEADER_HEIGHT = 48;
const WIDGET_COMPACT_HEADER_HEIGHT = 48;
...
const WIDGET_ADD_BUTTON_SIZE = 48;
const WIDGET_COMPACT_ADD_BUTTON_SIZE = 48;
const WIDGET_HERO_HEIGHT = 64;
const WIDGET_LIST_HERO_HEIGHT = 64;
const WIDGET_COMPACT_HERO_HEIGHT = 64;
