...
test('reminder detail sheet sizes to content and keeps delete action reachable', () => {
  ...
  assert.match(source, /windowHeight - sheetTopInset - safeAreaInsets\.bottom - DETAIL_SHEET_BOTTOM_CLEARANCE/);
  ...
  assert.match(source, /contentContainerStyle=\{\[styles\.content, \{ paddingBottom: detailContentBottomPadding \}\]\}/);
