...
test('settings action controls stay inside compact Android widths', () => {
  ...
  assert.match(source, /<SettingRow icon="color-palette-outline" title="テーマ" labelFlex=\{0\.36\} controlFlex=\{0\.64\}>/);
  assert.match(source, /<Text[\s\S]*numberOfLines=\{1\}[\s\S]*adjustsFontSizeToFit[\s\S]*minimumFontScale=\{0\.72\}[\s\S]*style=\{\[styles\.themeLabel, active \? styles\.themeLabelActive : null\]\}/);
  assert.match(source, /<Text[\s\S]*numberOfLines=\{1\}[\s\S]*adjustsFontSizeToFit[\s\S]*minimumFontScale=\{0\.72\}[\s\S]*style=\{styles\.notificationButtonText\}/);
  assert.match(source, /<Text[\s\S]*numberOfLines=\{1\}[\s\S]*adjustsFontSizeToFit[\s\S]*minimumFontScale=\{0\.72\}[\s\S]*style=\{styles\.devButtonText\}/);
  assert.match(source, /<Text[\s\S]*numberOfLines=\{1\}[\s\S]*adjustsFontSizeToFit[\s\S]*minimumFontScale=\{0\.72\}[\s\S]*style=\{styles\.cancelButtonText\}/);
  ...
  assert.match(source, /notificationButtonText: \{[\s\S]*flexShrink: 1,[\s\S]*includeFontPadding: false,/);
  assert.match(source, /devButtonText: \{[\s\S]*flexShrink: 1,[\s\S]*includeFontPadding: false,/);
  assert.match(source, /cancelButtonText: \{[\s\S]*flexShrink: 1,[\s\S]*includeFontPadding: false,/);
});
