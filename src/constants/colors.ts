...
export const bubbleDueColors = {
  today: {
    ...
    androidGradient: ['rgba(255,255,255,0.84)', 'rgba(248, 113, 113, 0.38)', 'rgba(248, 113, 113, 0.18)'],
  ...
  tomorrow: {
    ...
    androidGradient: ['rgba(255,255,255,0.84)', 'rgba(251, 146, 60, 0.36)', 'rgba(251, 146, 60, 0.16)'],
  ...
  soon: {
    ...
    androidGradient: ['rgba(255,255,255,0.84)', 'rgba(250, 204, 21, 0.34)', 'rgba(250, 204, 21, 0.14)'],
  ...
  later: {
    ...
    androidGradient: ['rgba(255,255,255,0.84)', 'rgba(125, 211, 252, 0.32)', 'rgba(52, 211, 153, 0.14)'],
