...
| リリース方針   | Android を先行し、App Store は後追いで同じ機能セットを確認する。Widget は別タスクとして扱う                        |
...
- 薄いフロスト面と文字ハローで、複雑・明暗どちらの壁紙でも文字と操作が明確に読める
- 時間帯ごとのリアルな空と薄いガラス／霞レイヤーで、背景の雲が見えつつ予定情報が明確に読める
