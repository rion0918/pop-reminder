...
- [ ] センサー値の取得後10秒間傾きを検出できない場合は、左右へ45度以上回転する案内と「もう一度試す」が表示される
- [ ] 縦向きから約45度以上右へ傾ける操作を20回行い、音声入力が自然に開始する
- [ ] 縦向きから約45度以上左へ傾ける操作を20回行い、音声入力が自然に開始する
...
- AQUOS zero5G basic（Android 12、RAM 6GB）、Android 9のRAM 3〜4GB端末、Android 14以上の端末で、固定した日本語30文を各3回確認する
